...
Referral.create( comment: 'Student needs some help with anger issues', user_id: '4' , student_id: '2' );
Referral.create( comment: 'Student needs counseling', user_id: '4' , student_id: '3' );
Referral.create( comment: 'gang intervention', user_id: '2' , student_id: '1' );
Referral.create( comment: 'peer mediation', user_id: '4' , student_id: '1' );
